local module = {
    ...
    ["Debug Subscription"] = false, --// Outputs whenever a subscription/RBXScriptConnection goes live and whenever a message is received
    ...
    ["Latency Upper Bound"] = 0.75, --// The slowest a message can be sent
    ...
    ["Server Generation Time Upper Bound"] = 0.75, --// The shortest time a server can be generated (simulated)
}
